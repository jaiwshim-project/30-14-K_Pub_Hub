...
const SPIN_KB = [
  ...
  // ===== 플랫폼 사용 가이드 =====
  { id: 'plat-1', tag: '교육 흐름', tags: ['교육', '시작', '입장', '로그인'], content: '교육 시작 흐름: 1) spin-selling.vercel.app 접속 → 2) 교육 세션(회사명) 선택 → 3) 비밀번호 입력 → 4) 역할 선택(강사/매니저/교육생) → 5) 교육생은 팀과 이름 선택 후 진입 → 6) 12가지 활동 메뉴에서 학습 진행.' },
