  ...
  <div class="footer-inner">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-badges">
        ...
        <a href="manual-user.html" style="background:rgba(46,204,113,0.15); border:1px solid rgba(46,204,113,0.3); color:#2ecc71; padding:4px 14px; border-radius:6px; font-size:11px; font-weight:600; text-decoration:none; transition:all 0.2s; cursor:pointer;" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='#2ecc71'">📘 매뉴얼</a>
        <a href="#" onclick="event.preventDefault();if(prompt('비밀번호:')==='9633')window.open('manual.html','_blank');else alert('비밀번호가 틀립니다');" style="background:rgba(245,166,35,0.15); border:1px solid rgba(245,166,35,0.3); color:var(--gold-light); padding:4px 14px; border-radius:6px; font-size:11px; font-weight:600; text-decoration:none; transition:all 0.2s; cursor:pointer;" onmouseover="this.style.color='#ffffff'" onmouseout="this.style.color='var(--gold-light)'">🔒 기술매뉴얼</a>
